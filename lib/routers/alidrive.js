const { request, IDHelper, _P } = require('../utils/node');
const logger = require('../utils/logger');
const { RTError } = require('../utils/node');

// Support paging and id addressing
...
class AliDrive extends IDHelper {
    static async build(config) {
        ...
        // @warning refresh_token The validity period is unknown and will be treated as permanently valid for the time being.
