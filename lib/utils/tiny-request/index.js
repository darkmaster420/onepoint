/**
 * Pure http request tool
 *
 * Redirection is not supported and needs to be handled manually
 *
 * method needs to be capitalized
 * url can contain Chinese characters
 * headers field capital format
 * responseType support json text
 *
 * Support default baseURL, headers
 */
